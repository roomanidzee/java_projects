...
public class UserRepositoryImpl implements UserRepository{
    ...
    public Optional<User> findByLogin(String login) {
        ...
        Optional<User> user = Optional.of(this.template.queryForObject(FIND_BY_LOGIN_QUERY, this.userRowMapper, login));
        this.users.clear();
    ...
    public Optional<User> findById(Long userId) {
        ...
        Optional<User> user = Optional.of(this.template.queryForObject(FIND_BY_ID_QUERY, this.userRowMapper, userId));
        this.users.clear();
    ...
    public Optional<User> findByConfirmHash(String confirmHash) {
        ...
        Optional<User> user = Optional.of(this.template.queryForObject(FIND_BY_HASH_QUERY, this.userRowMapper, confirmHash));
        this.users.clear();
